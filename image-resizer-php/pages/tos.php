...
<body class="text-slate-800 flex flex-col min-h-screen">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="<?php echo BASE_URL; ?>/pages/tos" class="text-blue-600 font-semibold">Terms Of Service</a>
            ...
            <div id="mobile-menu" class="mobile-menu md:hidden">
                <nav class="flex flex-col space-y-2 pb-4">
                    ...
                    <a href="<?php echo BASE_URL; ?>/pages/tos" class="block px-3 py-2 rounded-md text-base font-medium text-blue-600 bg-slate-100">Terms Of Service</a>
    ...
    <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div class="content-card max-w-4xl mx-auto p-6 sm:p-8 lg:p-10">
            <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">Terms of Service</h1>
            <div class="prose max-w-none text-slate-600">
                <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the <?php echo SITE_NAME; ?> website (the "Service") operated by us.</p>
                <p>Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms. These Terms apply to all visitors, users, and others who access or use the Service.</p>
                
                <h2>Content</h2>
                <p>Our Service allows you to upload, process, and download images. You are responsible for the content that you process on the Service, including its legality, reliability, and appropriateness.</p>

                <h2>Prohibited Uses</h2>
                <p>You may use the Service only for lawful purposes. You agree not to use the Service:</p>
                <ul>
                    <li>In any way that violates any applicable national or international law or regulation.</li>
                    <li>To process any material which is defamatory, obscene, indecent, abusive, offensive, harassing, violent, hateful, inflammatory, or otherwise objectionable.</li>
