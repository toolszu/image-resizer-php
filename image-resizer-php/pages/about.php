...
<body class="text-slate-800 flex flex-col min-h-screen">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="<?php echo BASE_URL; ?>/pages/about" class="text-blue-600 font-semibold">About</a>
            ...
            <div id="mobile-menu" class="mobile-menu md:hidden">
                <nav class="flex flex-col space-y-2 pb-4">
                    ...
                    <a href="<?php echo BASE_URL; ?>/pages/about" class="block px-3 py-2 rounded-md text-base font-medium text-blue-600 bg-slate-100">About</a>
    ...
    <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div class="content-card max-w-4xl mx-auto p-6 sm:p-8 lg:p-10">
            <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">About Us</h1>
            <div class="prose max-w-none text-slate-600">
                <p>Welcome to <?php echo SITE_NAME; ?>! Our mission is to provide a simple, fast, and free tool to help you resize your images effortlessly. We understand the need for properly sized images for websites, social media, emails, and more, and we built this tool to make that process as easy as possible.</p>
                <p>Our tool is designed for everyone - from professional web developers to casual social media users. There's no need to download or install any software. Everything works directly in your browser. We prioritize your privacy and security; your images are processed on the fly and are automatically deleted from our servers after a short period.</p>
                <p>Thank you for using our service. We are constantly working to improve it and welcome any feedback you might have.</p>
            </div>
        </div>
    </main>
