...
<head>
    ...
    <title>Disclaimer - <?php echo SITE_NAME; ?></title>
...
<body class="text-slate-800 flex flex-col min-h-screen">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="<?php echo BASE_URL; ?>/pages/disclaimer" class="text-blue-600 font-semibold">Disclaimer</a>
                </nav>
                <div class="md:hidden">
            ...
            <div id="mobile-menu" class="mobile-menu md:hidden">
                <nav class="flex flex-col space-y-2 pb-4">
                    ...
                    <a href="<?php echo BASE_URL; ?>/pages/disclaimer" class="block px-3 py-2 rounded-md text-base font-medium text-blue-600 bg-slate-100">Disclaimer</a>
                </nav>
            </div>
        </div>
    </header>
    ...
    <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div class="content-card max-w-4xl mx-auto p-6 sm:p-8 lg:p-10">
            <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">Disclaimer</h1>
            <div class="prose max-w-none text-slate-600">
                <p>The information provided by <?php echo SITE_NAME; ?> ("we," "us," or "our") on this website is for general informational purposes only. All information on the site is provided in good faith, however, we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the site.</p>
                <p>Under no circumstance shall we have any liability to you for any loss or damage of any kind incurred as a result of the use of the site or reliance on any information provided on the site. Your use of the site and your reliance on any information on the site is solely at your own risk.</p>
                <p>The tool is provided for free and without any warranties. We are not responsible for any loss of data or other damages that may result from its use.</p>
            </div>
        </div>
    </main>
